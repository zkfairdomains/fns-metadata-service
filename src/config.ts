...
const ADDRESS_ETH_REGISTRAR = process.env.ADDRESS_ETH_REGISTRAR || '0x67b9fb2dF83A33f8E1a8a99102242aD0A110835a';
const ADDRESS_ETH_REGISTRY = process.env.ADDRESS_ETH_REGISTRY || '0xc6390F725F974EbFd6f6B48fbe28DC01867feA76';
